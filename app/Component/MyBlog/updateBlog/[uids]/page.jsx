...
function UpDateBlog(params) {
  let router=useRouter()
    ...
    console.log(params.params.uids)
  ...
  useEffect(()=>{
    ...
    //     url: `http://localhost:3000/api/blog/${id}/${params.params.uids}`,
    //     headers: { }
    //   };
    ...
    let config = {
        method: 'get',
        maxBodyLength: Infinity,
        url: `http://localhost:3000/api/MyBlog/${id}/${params.params.uids}`,
        headers: { }
      };
...
//     method: 'put',
//     maxBodyLength: Infinity,
//     url: `http://localhost:3000/api/blog/${params.params.uids}`,
//     headers: { 
